...
export const routes: Routes = [
  ...
  { path: 'app/perfil/:slug', loadComponent: () => import('./screens/public-profile').then((m) => m.PublicProfileScreen), canActivate: [perfilGuard] },
  ...
  { path: 'perfil/:slug', loadComponent: () => import('./screens/public-profile').then((m) => m.PublicProfileScreen) },
