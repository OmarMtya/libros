...
export const QUESTIONS: QuestionSeed[] = [
  ...
  { key: 'Q05_SLOW_BURN_TOLERANCE', text: 'Puedo disfrutar una historia lenta aunque tarde en mostrar hacia dónde va.', type: 'scale', required: true, order: 5, branch: { show: 'Q05A_SLOW_BURN_CONDITIONS', minimumScale: 2 }, options: [{ key: 'scale', label: 'Escala 1 a 5', mappings: scale('slow_burn_tolerance', 'q05_slow_burn') }] },
