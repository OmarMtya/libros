...
export const QUESTIONS: QuestionSeed[] = [
  ...
  { key: 'Q09_CHARACTER_PREFERENCES', text: '¿Qué clase de personajes disfrutas más?', type: 'multi_select', required: true, order: 10, validation: { maxItems: 3 }, options: [
...
export function isQuestionVisible(questionKey: string, answered: ReadonlyMap<string, unknown>): boolean {
  if (questionKey !== 'Q05A_SLOW_BURN_CONDITIONS') return true;
