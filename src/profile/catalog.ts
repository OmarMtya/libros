...
export const QUESTIONS: QuestionSeed[] = [
  { key: 'Q01_LOVED_BOOKS', text: 'Agrega de 1 a 20 libros que hayas disfrutado mucho e indica qué aspecto te gustó de cada uno.', type: 'book_search', required: false, order: 1, validation: { minItems: 1, maxItems: 20, likedAspectsRequired: true } },
  { key: 'Q02_DISLIKED_BOOK', text: 'Agrega de 1 a 20 libros que no te hayan gustado o que hayas abandonado e indica el motivo de cada uno.', type: 'book_search', required: false, order: 2, validation: { minItems: 1, maxItems: 20, reasonCodesRequired: true } },
  ...
  { key: 'Q05A_SLOW_BURN_CONDITIONS', text: '¿Qué tendría que ofrecerte para que esa lentitud valga la pena?', type: 'multi_select', required: true, order: 6, validation: { maxItems: 3 }, branch: { dependsOn: 'Q05_SLOW_BURN_TOLERANCE', minimumNormalized: 0.25 }, options: [{ key: 'strong_characters', label: 'Personajes fuertes' }, { key: 'tension', label: 'Tensión' }, { key: 'atmosphere', label: 'Atmósfera' }, { key: 'beautiful_style', label: 'Estilo bello' }, { key: 'interesting_ideas', label: 'Ideas interesantes' }, { key: 'clear_progress', label: 'Progreso claro' }] },
